"""
Vendored from cqylunlun/GLASS (MIT License, Copyright (c) 2024 Qiyu Chen).

Source: https://github.com/cqylunlun/GLASS/blob/main/perlin.py

Vendored unchanged so the synthesizer app is self-contained (clone &
run without needing the GLASS repo alongside). See LICENSE_GLASS in
the package root for the upstream MIT license terms.
"""
